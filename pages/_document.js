  ...
  render() {
    return (
      <html lang="en">
        ...
        <link rel="apple-touch-icon" type="image/png" sizes="512x512" href="/public/icons/icon-512x512.png" />
        <link rel="icon" type="image/png" sizes="192x192" href="/public/icons/icon-192x192.png" />
        <link rel="apple-touch-icon" type="image/png" sizes="192x192" href="/public/icons/icon-192x192.png" />
        </Head>
        <body>
          <Main />
          <NextScript />
